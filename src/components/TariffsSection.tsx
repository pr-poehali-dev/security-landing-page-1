...
const TARIFFS: Tariff[] = [
  ...
  },
  {
    ...
    schedule: '24 часа',
    extras: [
      { text: 'Все услуги пакета "Базовый"' },
      { text: 'Все услуги пакета "Бизнес"' },
      { text: 'Все услуги пакета "Престиж"' },
      { text: 'Комплекс мер физической защиты с правом применения табельного оружия для отражения вооруженного нападения' },
      { text: 'Вооруженная инкассация' },
      { text: 'Приоритетное обслуживание' },
      { text: 'Консультации юрисконсульта' },
    ],
    price: 'от 365 000 ₽',
  },
];
